...
execute "Download MSGW Base package" do
 user "root" 
 command "wget -H -r --level=1 -nd -np -A \"NOVLIDMMSGWB*.jar\" -P /tmp/plugins http://blr-builder.labs.blr.novell.com/artifacts/designer_updatesite2/4.0/Publish2/plugins/"
  action :run
end
